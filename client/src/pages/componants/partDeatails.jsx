        ...
        <div className="px-4 sm:px-6 py-4 sm:py-5 border-b border-gray-200">
            ...
            <div className="flex gap-2 sm:gap-3 justify-end">
                ...
                {/* <div className="flex gap-2"> */}
                    ...
                    <button className="border-2 border-red-800 bg-red-800/20 text-red-800 sm:text-sm text-xs font-semibold px-4 py-2 rounded-xl transition-all duration-300 hover:bg-red-800 hover:text-white shadow-md flex items-center justify-center gap-2">
                    ...
                    {/* Add Parts Button */}
                    <button onClick={()=>setShow(true)} className="border-2 border-blue-800 bg-blue-800/20 text-blue-800 sm:text-sm text-xs font-semibold px-4 py-2 rounded-xl transition-all duration-300 hover:bg-blue-800 hover:text-white shadow-md flex items-center justify-center gap-2">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
